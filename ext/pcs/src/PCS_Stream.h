...
static int PCS_Stream_seek(php_stream *stream, zend_off_t offset, int whence, zend_off_t *newoffset);
static PCS_Node *PCS_Stream_getNodeFromURI(const char *uri, size_t len);
static int do_stat(php_stream_wrapper *wrapper, const char *uri, PCS_STREAM_DATA *dp, php_stream_statbuf *ssb);
